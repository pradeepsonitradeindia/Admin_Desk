...
class AsyncCollection(common.BaseObject, Generic[_DocumentType]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not isinstance(database, AsyncDatabase):
            ...
            if not any(
                cls.__name__ == "AsyncDatabase" for cls in type(database).__mro__
            ):
                raise TypeError(
    ...
    async def _drop_index(
        ...
        **kwargs: Any,
        ...
        if not isinstance(name, str):
            raise TypeError(
                f"index_or_name must be an instance of str or list, not {type(name)}"
            )
    ...
    async def create_search_index(
        ...
        **kwargs: Any,
        ...
        return (await self._create_search_indexes([model], session, comment, **kwargs))[
            0
        ]
    ...
    async def rename(
        ...
        **kwargs: Any,
        ...
        if not isinstance(new_name, str):
            raise TypeError(
                f"new_name must be an instance of str, not {type(new_name)}"
            )
