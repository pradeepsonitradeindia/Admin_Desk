...
async def _connect_kms(
    ...
    try:
        ...
        _raise_connection_failure(
            address, exc, timeout_details=_get_timeout_details(opts)
        )
...
class _EncryptionIO(AsyncMongoCryptCallback):  # type: ignore[misc]
    ...
    async def kms_request(self, kms_context: MongoCryptKmsContext) -> None:
        ...
        try:
            ...
            try:
                ...
                while kms_context.bytes_needed > 0:
                    ...
                    if _IS_SYNC:
                        ...
                        data = await async_receive_data_socket(
                            conn, kms_context.bytes_needed
                        )
                    if not data:
            ...
            if isinstance(exc, NetworkTimeout) or (
